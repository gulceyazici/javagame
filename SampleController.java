...
public class SampleController  implements Initializable  {
	...
	public void switchToSinglePlayerScreen(ActionEvent event) throws IOException {

		
		
	}

	public void switchToMultiPlayerScreen(ActionEvent event) throws IOException {
		AnchorPane root = FXMLLoader.load(getClass().getResource("personMouseController.java"));
		
		stageMultiPlayer = (Stage)((Node)event.getSource()).getScene().getWindow();
	
		scene = new Scene(root);
		scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
		stageMultiPlayer.setScene(scene);
		new personMouseController();
		stageMultiPlayer.show();
